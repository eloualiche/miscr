...
#'
#' @param x1: vector of x (horizontal) coordinates for the first line
#' @param y1: vector of y (vertical) coordinates for the first line
#' @param x2: vector of x (horizontal) coordinates for the second line
#' @param y2: vector of y (vertical) coordinates for the second line
